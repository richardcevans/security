...
export ENTRA_SCHEMA_ROLE="${ENTRA_SCHEMA_ROLE:-EMPLOYEES}"
...
echo -e "${GREEN}============================================================================${NC}"
echo
echo -e "${CYAN}ENTRA_SCHEMA_ROLE  = ${ENTRA_SCHEMA_ROLE}${NC}"
...
CREATE USER IF NOT EXISTS entra_shared_schema
  IDENTIFIED GLOBALLY AS 'AZURE_ROLE=${ENTRA_SCHEMA_ROLE}';
GRANT CREATE SESSION TO entra_shared_schema;
