#!/usr/bin/env bash
# Optional Oracle Instant Client and SQL*Plus installation for this host.
set -euo pipefail
...
arch=$(uname -m)
case "$arch" in x86_64|aarch64) ;; *) echo "ERROR: Unsupported CPU architecture: $arch" >&2; exit 1 ;; esac
