...
echo 'Iceberg order history is ready in the wallet bucket.'
SCRIPT
...
add_section /usr/local/sbin/install-deep-sec-admin-console 'Install database setup scripts' 'admin_database_stage'
