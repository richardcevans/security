...
find "$stage_dir/admin-app" -name '__pycache__' -type d -prune -exec rm -rfv {} +
...
(cd "$stage_dir" && zip -qr "$script_dir/dist/deep-data-security-flask-app.zip" flask-app admin-app database)
