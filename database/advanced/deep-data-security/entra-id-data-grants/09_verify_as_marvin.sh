#!/bin/bash
# =========================================================================================
# Script Name : 09_verify_as_marvin.sh
#
# Parameter   : None
#
...
echo
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}      Task 9: Connect and Verify as Marvin (via Entra ID)                   ${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo
...
then
  echo
  echo -e "${RED}============================================================================${NC}"
  echo -e "${RED}ERROR: ENTRA ID DATABASE LOGIN OR VERIFICATION FAILED${NC}"
  echo -e "${RED}============================================================================${NC}"
  echo "Check the browser signed in as Marvin and that Marvin has EMPLOYEES and MANAGERS."
  echo "Use a private/incognito browser session, then rerun ./09_verify_as_marvin.sh."
  echo "For ORA-01017, run ./08_verify_db_setup.sh and review the database alert log."
  echo -e "${RED}============================================================================${NC}"
  exit 1
fi
...
echo -e "${GREEN}      Next: run 10_verify_as_emma.sh                                        ${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo
