...
#               VS Code / Oracle client trust store.
...
echo -e "${YELLOW}Step 3: Creating an optional PKCS12 truststore for JDBC clients...${NC}"
...
Example Java truststore properties on Windows:
...
Example Java truststore properties on Linux or macOS:
