#!/bin/bash
# Shared OCI CLI profile selection for the Deep Data Security labs.
#
# OCI_PROFILE_NAME is the preferred lab-facing name. OCI_PROFILE and
# OCI_CLI_PROFILE remain supported for compatibility with OCI CLI workflows.
...
# Use this wrapper for every OCI CLI call in a lab script.
oci_with_profile() {
