...
echo -e "${PURPLE}Open http://localhost:$PORT in your browser and sign in via Microsoft Entra ID${NC}"
echo -e "${PURPLE}as marvin@domain.com or emma@domain.com to see the filtered views yourself.${NC}"
echo
echo -e "${GREEN}============================================================================${NC}"
