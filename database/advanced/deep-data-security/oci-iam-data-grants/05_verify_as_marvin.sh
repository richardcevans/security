...
prompt
prompt ========================================================================
prompt Marvin's Identity (via OCI IAM)
prompt  - CURRENT_USER = XS\$NULL (end user, not a schema user)
prompt  - AUTHENTICATED_IDENTITY = marvin's OCI IAM identity
...
prompt  - Activated automatically from the OCI IAM token groups
prompt ========================================================================
...
echo -e "${GREEN}      Authenticated via OCI IAM. Data grants enforced by the database.     ${NC}"
