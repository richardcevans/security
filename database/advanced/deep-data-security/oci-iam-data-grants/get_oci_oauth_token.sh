...
if not code:
    ...
    if headless:
        ...
        print("In Chrome, a successful redirect often ends on: This site can't be reached.")
        print("That is fine when the address bar shows localhost with code= and state=.")
