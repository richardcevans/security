#!/bin/bash
# Set OCI IAM passwords for the demo users created by 00_setup_oci_iam.sh.
...
Environment:
  OCI_DOMAIN_URL      OCI IAM identity domain URL. Usually loaded from .oci-iam-data-grants.env.
