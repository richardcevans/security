...
#               creates end users, data roles, data grants, and end user context.
...
echo -e "${PURPLE}  2. Create end users (marvin, emma)${NC}"
...
prompt
prompt ========================================================================
prompt Step 2: Create End Users
prompt  - End users authenticate but do not own schemas.
prompt  - They land in XS\$NULL — least privilege by default.
prompt  - Traditional: CREATE USER marvin IDENTIFIED BY ...
prompt  - Migration:   CREATE END USER marvin IDENTIFIED BY ...
prompt ========================================================================
...
prompt GRANT DATA ROLE hrapp_employees_local TO emma;
GRANT DATA ROLE hrapp_employees_local TO emma;
prompt GRANT DATA ROLE hrapp_employees_local TO marvin;
GRANT DATA ROLE hrapp_employees_local TO marvin;
prompt GRANT DATA ROLE hrapp_managers_local TO marvin;
