...
### Objectives
This Hands-On Lab gives the user an opportunity to learn how to migrate an existing application from traditional Oracle Database users, roles, and grants to **Oracle Deep Data Security** end users, data roles, and data grants — so the database enforces per-user access with zero application filtering code.
